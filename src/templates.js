...
function email1(customer, amount, currency) {
            ...
            return {
                          ...
                          text: `Hi ${name},
                          I noticed your recent payment of ${formatAmount(amount, currency)} for Outreach Today didn't go through. This usually happens due to insufficient funds, an expired card, or a temporary bank hold.
                          Nothing to worry about — we'll automatically retry in a few days. If you'd like to update your payment details beforehand, just reply to this email and I'll send you a direct link.
                          Thanks,
                          Anastasia
...
function email2(customer, amount, currency) {
            ...
            return {
                          ...
                          Your account is still active, but to avoid any interruption please update your payment method when you get a chance. Reply to this email if you need a payment link or have any questions.
                          Best,
                          Anastasia
                          Customer Support, Outreach Today`
            };
...
function email3(customer, amount, currency) {
            ...
            return {
                          ...
                          If there's anything I can help with, please reply to this email. I'm here to help.
                          Best,
                          Anastasia
                          Customer Support, Outreach Today`
            };
